    ...
    return `
      <div class="bulk-actions-bar">
        ...
        <div class="bulk-buttons">
          <button class="btn-secundario" id="bulkExportCli"><i data-lucide="file-text"></i> Exportar</button>
  ...
  abrirFicha(id) {
    ...
    abrirModal(`
      ...
      <div class="modal-acoes">
        ...
        <button class="btn-primario" id="btnEditarFichaCliente"><i data-lucide="pen"></i> Editar</button>
      </div>
    `);
