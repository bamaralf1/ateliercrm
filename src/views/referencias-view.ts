    ...
    if (r.tipo === 'imagem') {
      corpoHtml = `
        ...
        <div class="corpo-referencia">
          <div class="icone-tipo-referencia"><i data-lucide="images"></i> Imagem</div>
      ...
      corpoHtml = `
        ...
        <div class="corpo-referencia">
          <div class="icone-tipo-referencia"><i data-lucide="link"></i> Link externo</div>
          ${r.titulo ? `<div class="titulo-referencia">${r.titulo}</div>` : ''}
      ...
      corpoHtml = `
        <div class="corpo-referencia" data-apresentar="${indice}" style="cursor:pointer;">
          <div class="icone-tipo-referencia"><i data-lucide="pencil"></i> Nota</div>
          ${r.titulo ? `<div class="titulo-referencia">${r.titulo}</div>` : ''}
    ...
    return `
      <div class="card-referencia" draggable="true" data-indice="${indice}" data-id="${r.id}">
        ...
        <div class="acoes-referencia">
          <button class="btn-icone-tabela" data-excluir-referencia="${r.id}" style="flex:1;"><i data-lucide="trash-2"></i> Excluir</button>
        </div>
      </div>
    `;
  }
  ...
  abrirFormulario() {
    ...
    abrirModal(`
      ...
      <div class="grupo-botoes-toggle" id="grupoTipoReferencia">
        <button type="button" class="ativo" data-tipo-ref="imagem"><i data-lucide="images"></i> Imagem</button>
        <button type="button" data-tipo-ref="link"><i data-lucide="link"></i> Link</button>
        <button type="button" data-tipo-ref="nota"><i data-lucide="pencil"></i> Nota</button>
      </div>
