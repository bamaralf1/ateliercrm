...
export class DataStore {
  ...
  popularExemplos() {
    ...
    this.dados.obras = [
      ...
      { id: 'obra_ex_2', titulo: 'Autorretrato em Ocre', tecnica: 'óleo', dimensoes: { altura: 50, largura: 40, profundidade: 0 }, ano: 2023, descricao: 'Autorretrato em tons terrosos, explorando contrastes de luz e sombra sobre o rosto.', preco: 2100, status: 'vendida', imagem: gerarImagemPlaceholder('#8b5e3c', '🧑‍<i data-lucide="palette"></i>'), dataCadastro: mesesAtras(5), criadoEm: mesesAtras(5), serie: '', custoMateriais: 180, horasTrabalho: 16, historicoPrecos: [{ preco: 1500, data: '2024-10-01', motivo: 'Preço inicial' }, { preco: 1800, data: '2025-02-10', motivo: 'Ajuste' }, { preco: 2100, data: '2025-06-20', motivo: 'Valorização' }], imagens: [gerarImagemPlaceholder('#8b5e3c', '🧑‍<i data-lucide="palette"></i>')], imagemDestacada: gerarImagemPlaceholder('#8b5e3c', '🧑‍<i data-lucide="palette"></i>') },
    ...
    this.dados.materiais = [
      ...
      { id: 'mat_6', nome: 'Moldura Clássica 30×40', categoria: 'molduras', subcategoria: 'clássica', marca: 'Molduraz', quantidade: 2, unidade: 'un', quantidadeMinima: 4, local: 'Depósito', dataAquisicao: '2025-06-10', validade: '', precoUnitario: 65, foto: '', notas: '<i data-lucide="triangle-alert"></i> ABAIXO DO MÍNIMO — repor urgente!' }
    ];
