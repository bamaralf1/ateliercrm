...
`], ...formatTraceEntry(entry));
  ...
  var stack, isWarning, ErrorTypeStrings$1, queue, flushIndex, pendingPostFlushCbs, activePostFlushCbs, postFlushIndex, resolvedPromise, currentFlushPromise, RECURSION_LIMIT, getId, isHmrUpdating, hmrDirtyComponents, map, currentRenderingInstance, ssrContextKey, useSSRContext, requestIdleCallback, cancelIdleCallback, createHook, onBeforeMount, onMounted, onBeforeUpdate, onUpdated, onBeforeUnmount, onUnmounted, onServerPrefetch, onRenderTriggered, onRenderTracked, getPublicInstance, publicPropertiesMap, isReservedPrefix, hasSetupBinding, PublicInstanceProxyHandlers, shouldCacheAccess, internalOptionMergeStrats, currentApp, accessedAttrs, queuePostRenderEffect, emptyAppContext, currentInstance, getCurrentInstance, internalSetCurrentInstance, setInSSRSetupState, setCurrentInstance, isInSSRComponentSetup, classifyRE, classify, computed2, warn2;
  var init_runtime_core_esm_bundler = __esm({
    "node_modules/@vue/runtime-core/dist/runtime-core.esm-bundler.js"() {
      ...
      createHook = (lifecycle) => (hook2, target2 = currentInstance) => {
  ...
  var captureStackTrace, Diagnostic;
  var init_dist = __esm({
    "node_modules/nostics/dist/index.mjs"() {
      captureStackTrace = Error.captureStackTrace;
      Diagnostic = class Diagnostic2 extends Error {
        name;
        /**
  ...
  var __create, __defProp2, __getOwnPropDesc2, __getOwnPropNames2, __getProtoOf, __hasOwnProp2, __commonJSMin, __copyProps2, __toESM, isBrowser, target, isInChromePanel, isInIframe, isInElectron, isNuxtApp, import_rfdc, classifyRE2, deepClone;
  var init_dist2 = __esm({
    "node_modules/@vue/devtools-shared/dist/index.js"() {
      ...
      __toESM = (mod, isNodeMode, target2) => (target2 = mod != null ? __create(__getProtoOf(mod)) : {}, __copyProps2(isNodeMode || !mod || !mod.__esModule ? __defProp2(target2, "default", {
        value: mod,
        enumerable: true
      }) : target2, mod));
      isBrowser = typeof navigator !== "undefined";
      target = typeof window !== "undefined" ? window : typeof globalThis !== "undefined" ? globalThis : typeof global !== "undefined" ? global : {};
      isInChromePanel = typeof target.chrome !== "undefined" && !!target.chrome.devtools;
      isInIframe = isBrowser && target.self !== target.top;
      isInElectron = typeof navigator !== "undefined" && navigator.userAgent?.toLowerCase().includes("electron");
      isNuxtApp = typeof window !== "undefined" && !!window.__NUXT__;
      import_rfdc = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
        module.exports = rfdc;
      ...
      classifyRE2 = /(?:^|[-_/])(\w)/g;
      deepClone = (0, import_rfdc.default)({ circles: true });
    }
  });
  ...
  var init_dist3 = __esm({
    "node_modules/perfect-debounce/dist/index.mjs"() {
      DEBOUNCE_DEFAULTS = { trailing: true };
    }
  });
  ...
  var defaultTask, _createTask, createTask, Hookable;
  ...
  var __create2, __defProp3, __getOwnPropDesc3, __getOwnPropNames3, __getProtoOf2, __hasOwnProp3, __commonJSMin2, __copyProps3, __toESM2, range, DEFAULT_RECT, CONTAINER_ELEMENT_ID, CARD_ELEMENT_ID, COMPONENT_NAME_ELEMENT_ID, INDICATOR_ELEMENT_ID, containerStyles, cardStyles, indicatorStyles, inspectInstance, inspectComponentHighLighterSelectFn, ReactiveFlags, StateEditor, RefStateEditor, stateEditor, TIMELINE_LAYERS_STATE_STORAGE_ID, devtoolsTimelineLayers, devtoolsInspector, callInspectorUpdatedHook, DevToolsV6PluginAPIHookKeys, DevToolsContextHookKeys, DevToolsMessagingHookKeys, STATE_KEY, callStateUpdatedHook, callConnectedUpdatedHook, devtoolsAppRecords, activeAppRecord, devtoolsState, devtoolsPluginBuffer, DevToolsHooks, devtoolsHooks, on, hook, DevToolsV6PluginAPI, DevToolsPluginAPI, UNDEFINED, INFINITY, NEGATIVE_INFINITY, NAN, tokenMap, reversedTokenMap, ROUTER_KEY, ROUTER_INFO_KEY, devtoolsRouterInfo, devtoolsRouter, hooks, devtoolsContext, require_speakingurl$1, import_speakingurl, appRecordInfo, DoubleIndexedKV, Registry, ClassRegistry, CustomTransformerRegistry, getType$1, isUndefined$1, isNull$1, isPlainObject$2, isEmptyObject, isArray$2, isString2, isNumber, isBoolean, isRegExp2, isMap2, isSet2, isSymbol2, isDate, isError, isNaNValue, isPrimitive, isBigint, isInfinite, isTypedArray, isURL, escapeKey, stringifyPath, parsePath, simpleRules, symbolRule, constructorToName, typedArrayRule, classRule, customRule, compositeRules, transformValue, simpleRulesByAnnotation, untransformValue, getNthKey, getDeep, setDeep, isDeep, walker, SuperJSON, MAX_SERIALIZED_SIZE;
  var init_dist5 = __esm({
    "node_modules/@vue/devtools-kit/dist/index.js"() {
      ...
      __commonJSMin2 = (cb, mod) => () => (mod || cb((mod = { exports: {} }).exports, mod), mod.exports);
      ...
      __toESM2 = (mod, isNodeMode, target2) => (target2 = mod != null ? __create2(__getProtoOf2(mod)) : {}, __copyProps3(isNodeMode || !mod || !mod.__esModule ? __defProp3(target2, "default", {
        value: mod,
        enumerable: true
      }) : target2, mod));
      DEFAULT_RECT = {
      ...
      CONTAINER_ELEMENT_ID = "__vue-devtools-component-inspector__";
      CARD_ELEMENT_ID = "__vue-devtools-component-inspector__card__";
      COMPONENT_NAME_ELEMENT_ID = "__vue-devtools-component-inspector__name__";
      INDICATOR_ELEMENT_ID = "__vue-devtools-component-inspector__indicator__";
      containerStyles = {
        display: "block",
        zIndex: 2147483640,
        position: "fixed",
      ...
      ReactiveFlags = /* @__PURE__ */ (function(ReactiveFlags2) {
      ...
      TIMELINE_LAYERS_STATE_STORAGE_ID = "__VUE_DEVTOOLS_KIT_TIMELINE_LAYERS_STATE__";
      target.__VUE_DEVTOOLS_KIT_TIMELINE_LAYERS ??= [];
      devtoolsTimelineLayers = new Proxy(target.__VUE_DEVTOOLS_KIT_TIMELINE_LAYERS, { get(target2, prop, receiver) {
        return Reflect.get(target2, prop, receiver);
      } });
      target.__VUE_DEVTOOLS_KIT_INSPECTOR__ ??= [];
      devtoolsInspector = new Proxy(target.__VUE_DEVTOOLS_KIT_INSPECTOR__, { get(target2, prop, receiver) {
        return Reflect.get(target2, prop, receiver);
      } });
      callInspectorUpdatedHook = debounce(() => {
        devtoolsContext.hooks.callHook(DevToolsMessagingHookKeys.SEND_INSPECTOR_TO_CLIENT, getActiveInspectors());
      });
      DevToolsV6PluginAPIHookKeys = /* @__PURE__ */ (function(DevToolsV6PluginAPIHookKeys2) {
      ...
      DevToolsContextHookKeys = /* @__PURE__ */ (function(DevToolsContextHookKeys2) {
      ...
      DevToolsMessagingHookKeys = /* @__PURE__ */ (function(DevToolsMessagingHookKeys2) {
      ...
      STATE_KEY = "__VUE_DEVTOOLS_KIT_GLOBAL_STATE__";
      target[STATE_KEY] ??= initStateFactory();
      callStateUpdatedHook = debounce((state) => {
        devtoolsContext.hooks.callHook(DevToolsMessagingHookKeys.DEVTOOLS_STATE_UPDATED, { state });
      });
      callConnectedUpdatedHook = debounce((state, oldState) => {
        devtoolsContext.hooks.callHook(DevToolsMessagingHookKeys.DEVTOOLS_CONNECTED_UPDATED, {
          state,
          oldState
        });
      });
      devtoolsAppRecords = new Proxy(target.__VUE_DEVTOOLS_KIT_APP_RECORDS__, { get(_target, prop, receiver) {
        if (prop === "value") return target.__VUE_DEVTOOLS_KIT_APP_RECORDS__;
        return target.__VUE_DEVTOOLS_KIT_APP_RECORDS__[prop];
      } });
      activeAppRecord = new Proxy(target.__VUE_DEVTOOLS_KIT_ACTIVE_APP_RECORD__, { get(_target, prop, receiver) {
      ...
      devtoolsState = new Proxy(target[STATE_KEY], {
      ...
      devtoolsPluginBuffer = new Proxy(target.__VUE_DEVTOOLS_KIT_PLUGIN_BUFFER__, { get(target2, prop, receiver) {
        return Reflect.get(target2, prop, receiver);
      } });
      DevToolsHooks = /* @__PURE__ */ (function(DevToolsHooks2) {
      ...
      devtoolsHooks = target.__VUE_DEVTOOLS_HOOK ??= createHooks();
      on = {
        vueAppInit(fn) {
      ...
      DevToolsPluginAPI = DevToolsV6PluginAPI;
      UNDEFINED = "__vue_devtool_undefined__";
      INFINITY = "__vue_devtool_infinity__";
      NEGATIVE_INFINITY = "__vue_devtool_negative_infinity__";
      NAN = "__vue_devtool_nan__";
      tokenMap = {
        [UNDEFINED]: "undefined",
        [NAN]: "NaN",
        [INFINITY]: "Infinity",
      ...
      reversedTokenMap = Object.entries(tokenMap).reduce((acc, [key, value]) => {
        acc[value] = key;
        return acc;
      }, {});
      target.__VUE_DEVTOOLS_KIT__REGISTERED_PLUGIN_APPS__ ??= /* @__PURE__ */ new Set();
      ROUTER_KEY = "__VUE_DEVTOOLS_ROUTER__";
      ROUTER_INFO_KEY = "__VUE_DEVTOOLS_ROUTER_INFO__";
      target[ROUTER_INFO_KEY] ??= {
        currentRoute: null,
        routes: []
      };
      target[ROUTER_KEY] ??= {};
      devtoolsRouterInfo = new Proxy(target[ROUTER_INFO_KEY], { get(target$1, property) {
        return target[ROUTER_INFO_KEY][property];
      } });
      devtoolsRouter = new Proxy(target[ROUTER_KEY], { get(target$2, property) {
      ...
      devtoolsContext = target.__VUE_DEVTOOLS_KIT_CONTEXT__;
      require_speakingurl$1 = /* @__PURE__ */ __commonJSMin2(((exports, module) => {
        (function(root) {
          "use strict";
          var charMap = {
            "\xC0": "A",
      ...
      import_speakingurl = /* @__PURE__ */ __toESM2((/* @__PURE__ */ __commonJSMin2(((exports, module) => {
        module.exports = require_speakingurl$1();
      })))(), 1);
      appRecordInfo = target.__VUE_DEVTOOLS_NEXT_APP_RECORD_INFO__ ??= {
        id: 0,
      ...
      getType$1 = (payload) => Object.prototype.toString.call(payload).slice(8, -1);
      isUndefined$1 = (payload) => typeof payload === "undefined";
      isNull$1 = (payload) => payload === null;
      isPlainObject$2 = (payload) => {
        if (typeof payload !== "object" || payload === null) return false;
        if (payload === Object.prototype) return false;
        if (Object.getPrototypeOf(payload) === null) return true;
        return Object.getPrototypeOf(payload) === Object.prototype;
      };
      isEmptyObject = (payload) => isPlainObject$2(payload) && Object.keys(payload).length === 0;
      isArray$2 = (payload) => Array.isArray(payload);
      ...
      isRegExp2 = (payload) => payload instanceof RegExp;
      isMap2 = (payload) => payload instanceof Map;
      isSet2 = (payload) => payload instanceof Set;
      isSymbol2 = (payload) => getType$1(payload) === "Symbol";
      ...
      isPrimitive = (payload) => isBoolean(payload) || isNull$1(payload) || isUndefined$1(payload) || isNumber(payload) || isString2(payload) || isSymbol2(payload);
      ...
      isDeep = (object, superJson) => isPlainObject$2(object) || isArray$2(object) || isMap2(object) || isSet2(object) || isInstanceOfRegisteredClass(object, superJson);
      ...
      MAX_SERIALIZED_SIZE = 2 * 1024 * 1024;
    }
  });
...
Only state can be modified.`);
  ...
  function storeToRefs(store) {
    ...
    for (const key in rawStore) {
      ...
      if (value?.effect) refs[key] = computed2({
        get: () => store[key],
        set(value2) {
          store[key] = value2;
        }
  ...
  var IS_CLIENT, diagnostics, activePinia, setActivePinia, getActivePinia, piniaSymbol, MutationType, _global, _navigator, isMacOSWebView, saveAs, fileInput, PINIA_ROOT_LABEL, PINIA_ROOT_ID, isTimelineActive, componentStateTypes, MUTATIONS_LAYER_ID, INSPECTOR_ID, assign$1, getStoreType, runningActionId, activeAction, isUseStore, noop, fallbackRunWithContext, ACTION_MARKER, ACTION_NAME, skipHydrateSymbol, assign, mapStoreSuffix, mapGetters;
  var init_pinia = __esm({
    "node_modules/pinia/dist/pinia.js"() {
      init_vue_runtime_esm_bundler();
      init_dist();
      init_dist6();
      IS_CLIENT = typeof window !== "undefined";
      diagnostics = /* @__PURE__ */ defineDiagnostics({
      ...
      piniaSymbol = true ? /* @__PURE__ */ Symbol("pinia") : (
        /* istanbul ignore next */
        /* @__PURE__ */ Symbol()
      );
      MutationType = /* @__PURE__ */ (function(MutationType2) {
      ...
      PINIA_ROOT_LABEL = "\u{1F34D} Pinia (root)";
      PINIA_ROOT_ID = "_root";
      isTimelineActive = true;
      componentStateTypes = [];
      ...
      ACTION_MARKER = /* @__PURE__ */ Symbol();
      ACTION_NAME = /* @__PURE__ */ Symbol();
      skipHydrateSymbol = true ? /* @__PURE__ */ Symbol("pinia:skipHydration") : (
        /* istanbul ignore next */
        /* @__PURE__ */ Symbol()
      );
      ({ assign } = Object);
      mapStoreSuffix = "Store";
      mapGetters = mapState;
    }
  });

  // js/atelier-crm.js
  var require_atelier_crm = __commonJS({
    "js/atelier-crm.js"(exports, module) {
      Object.defineProperty(exports, "__esModule", { value: true });
      exports.StoreBridge = exports.configStore = exports.useConfigStore = exports.vendaStore = exports.useVendaStore = exports.clienteStore = exports.useClienteStore = exports.obraStore = exports.useObraStore = exports.pinia = exports.CloudSync = exports.ConfiguracoesView = exports.FinanceiroView = exports.ExposicoesView = exports.ExportImportView = exports.ImageLightbox = exports.EncomendasView = exports.PortalView = exports.DiarioView = exports.RedeView = exports.AtelierView = exports.PrecificadorView = exports.GaleriaVirtualView = exports.ReferenciasView = exports.CertificadosView = exports.PDFGenerator = exports.VendasView = exports.ClientesView = exports.CatalogoView = exports.DashboardView = exports.BaseView = exports.Router = exports.ThemeEngine = exports.ActivityLogger = exports.EventBus = exports.DataStore = void 0;
      exports.formatarMoeda = formatarMoeda;
      exports.formatarData = formatarData;
      exports.mostrarToast = mostrarToast;
      exports.mostrarLoading = mostrarLoading;
      exports.esconderLoading = esconderLoading;
      exports.abrirModal = abrirModal;
      exports.fecharModal = fecharModal;
      exports.classeStatus = classeStatus;
      exports.rotuloStatus = rotuloStatus;
      exports.gerarImagemPlaceholder = gerarImagemPlaceholder;
      exports.calcularObrasPorMes = calcularObrasPorMes;
      exports.gerarGraficoSVG = gerarGraficoSVG;
      exports.calcularTecnicaMaisComum = calcularTecnicaMaisComum;
      exports.calcularCrescimentoMensal = calcularCrescimentoMensal;
      exports.renderizarViewPlaceholder = renderizarViewPlaceholder;
      exports.capitalizarTexto = capitalizarTexto;
      exports.classeStatusVenda = classeStatusVenda;
      exports.rotuloStatusVenda = rotuloStatusVenda;
      exports.gerarQRCodeDataUrl = gerarQRCodeDataUrl;
      exports.definicaoFormulario = definicaoFormulario;
      exports.montarCampoHtml = montarCampoHtml;
      exports.abrirModalNovoItem = abrirModalNovoItem;
      exports.abrirLightbox = abrirLightbox;
      exports.renderizarDashboard = renderizarDashboard;
      exports.sanitizarHTML = sanitizarHTML;
      exports.sanitizarURL = sanitizarURL;
      exports.sanitizarRich = sanitizarRich;
      exports.comprimirImagem = comprimirImagem;
      exports.observarImagens = observarImagens;
      exports.aplicarTransicaoView = aplicarTransicaoView;
      exports.debounce = debounce2;
      exports.abrirSpotlight = abrirSpotlight;
      exports.iniciarFab = iniciarFab;
      exports.mostrarAtalhos = mostrarAtalhos;
      exports.iniciarMonitorInatividade = iniciarMonitorInatividade;
      exports.bloquearTela = bloquearTela;
      exports.dispararConfetti = dispararConfetti;
      exports.obterDicaDoDia = obterDicaDoDia;
      exports.iniciarTour = iniciarTour;
      var pinia_1 = (init_pinia(), __toCommonJS(pinia_exports));
      ...
      function rotuloStatus(status) {
        ...
        return mapa[status] || "Dispon\xEDvel";
      }
  ...
  `;
      ...
      function calcularCrescimentoMensal(obras) {
        ...
        if (obrasMesAnterior === 0)
          return obrasEsteMes > 0 ? 100 : 0;
  ...
  `);
        ...
        importarBackup(jsonTexto) {
          try {
            ...
            if (typeof novosDados !== "object" || novosDados === null)
              throw new Error("Formato inv\xE1lido: esperado objeto");
            ...
            if (isBackupCompleto) {
              ...
              Object.keys(novosDados).forEach((chave) => {
                if (chave !== "exportadoEm" && chave !== "versao")
                  this.dados[chave] = novosDados[chave];
              });
            }
            this.salvar();
      ...
      var ActivityLogger = class {
        ...
        formatarTempo(data) {
          ...
          if (minutos < 1)
            return "Agora mesmo";
          if (minutos < 60)
            return `${minutos} min atr\xE1s`;
          if (horas < 24)
            return `${horas}h atr\xE1s`;
          if (dias < 7)
            return `${dias}d atr\xE1s`;
      ...
      var BaseView = class _BaseView {
        constructor(dataStore2, router2) {
          if (new.target === _BaseView)
            throw new Error("BaseView n\xE3o pode ser instanciada diretamente");
          this.dataStore = dataStore2;
          this.router = router2;
          this._bindCache = {};
      ...
      var DashboardView = class extends BaseView {
        ...
        obterWidgetsOrdenados() {
          ...
          if (!this.widgetOrdem || this.widgetOrdem.length === 0)
            return padrao;
        ...
        render() {
          const obras = (0, exports.obraStore)().items;
          const vendas = (0, exports.vendaStore)().items;
          const clientes = (0, exports.clienteStore)().items;
    ...
    `;
        ...
        gerarSparkline(itens, tipo) {
          ...
          if (pontos.every((p) => p === 0))
            return "";
          const max = Math.max(...pontos, 1);
          const w = 80, h2 = 30;
          const pts = pontos.map((p, i) => `${i / (pontos.length - 1) * w},${h2 - p / max * h2}`).join(" ");
          return `<svg width="${w}" height="${h2}" viewBox="0 0 ${w} ${h2}"><polyline fill="none" stroke="var(--kpi-cor)" stroke-width="2" points="${pts}"/></svg>`;
        }
    ...
    `;
        ...
        renderWidgetMetas() {
          const config = (0, exports.configStore)();
    ...
    `;
      ...
      var CatalogoView = class extends BaseView {
        ...
        obrasFiltradas() {
          ...
          let obras = (0, exports.obraStore)().items;
          if (f.busca) {
            const termo = f.busca.toLowerCase();
            obras = obras.filter((o) => (o.titulo || "").toLowerCase().includes(termo) || (o.descricao || "").toLowerCase().includes(termo) || (o.serie || "").toLowerCase().includes(termo));
          }
          if (f.tecnica)
            obras = obras.filter((o) => o.tecnica === f.tecnica);
          if (f.status)
            obras = obras.filter((o) => classeStatus(o.status) === classeStatus(f.status));
          if (f.ano)
            obras = obras.filter((o) => String(o.ano) === String(f.ano));
          if (f.precoMin !== "")
            obras = obras.filter((o) => Number(o.preco || 0) >= Number(f.precoMin));
          if (f.precoMax !== "")
            obras = obras.filter((o) => Number(o.preco || 0) <= Number(f.precoMax));
          if (this.filtroRapido === "favoritas")
            obras = obras.filter((o) => o.favorita);
          return [...obras].sort((a, b) => new Date(b.dataCadastro || b.criadoEm || 0) - new Date(a.dataCadastro || a.criadoEm || 0));
        }
        anosDisponiveis() {
          const anos = [...new Set((0, exports.obraStore)().items.map((o) => o.ano).filter(Boolean))];
    ...
    `;
        ...
        formatarDimensoes(dim) {
          if (!dim || !dim.altura && !dim.largura && !dim.profundidade)
            return "-";
        ...
        aposRenderizar() {
          ...
          if (ordenarEl)
            ordenarEl.addEventListener("change", (e) => {
          ...
          if (btnComparar)
            btnComparar.addEventListener("click", () => this.abrirComparacao(Array.from(this.selecionados)));
          ...
          if (fab)
            fab.addEventListener("click", () => this.abrirFormulario());
          ...
          if (btnSalvarFiltro)
            btnSalvarFiltro.addEventListener("click", () => this.salvarFiltroAtual());
        }
        aplicarFiltroRapido() {
          const agora = /* @__PURE__ */ new Date();
        ...
        bulkAcao(acao) {
          ...
          switch (acao) {
            case "favoritar":
              ids.forEach((id) => {
                const obra = (0, exports.obraStore)().porId(id);
                if (obra) {
                  obra.favorita = true;
                  (0, exports.obraStore)().atualizar(id, obra);
                }
              });
        ...
        `);
            ...
            case "exportarPDF":
              ...
              break;
            case "excluir":
              if (!confirm(`Tem certeza que deseja excluir ${ids.length} obra${ids.length === 1 ? "" : "s"}? Esta a\xE7\xE3o n\xE3o pode ser desfeita.`))
                return;
              ids.forEach((id) => (0, exports.obraStore)().remover(id));
        ...
        exportarObrasJSON(ids) {
          const obrasParaExportar = ids.map((id) => (0, exports.obraStore)().porId(id)).filter(Boolean);
        ...
        exportarCatalogoPDF(ids) {
          ...
          const obras = ids.map((id) => (0, exports.obraStore)().porId(id)).filter(Boolean);
          if (obras.length === 0)
            return;
          ...
          const nomeArtista = (0, exports.configStore)().artista && (0, exports.configStore)().artista.nome || "Ateli\xEA do Artista";
        ...
        abrirFormulario(id = null) {
          const obraExistente = id ? (0, exports.obraStore)().porId(id) : null;
    ...
    `);
          ...
          document.getElementById("formObra").addEventListener("submit", (e) => {
            ...
            if (obraExistente) {
              (0, exports.obraStore)().atualizar(obraExistente.id, dadosObra);
              mostrarToast("Obra atualizada com sucesso!");
            } else {
              dadosObra.dataCadastro = (/* @__PURE__ */ new Date()).toISOString();
              (0, exports.obraStore)().adicionar(dadosObra);
    ...
    `);
        ...
        iniciarBatchDrop() {
          ...
          fileInput2.addEventListener("change", () => {
            if (fileInput2.files.length)
              processarLote(fileInput2.files);
          });
        ...
        `;
            ...
            if (campos)
              campos.style.display = imagens.length > 0 ? "block" : "none";
            if (acoes)
              acoes.style.display = imagens.length > 0 ? "flex" : "none";
            ...
            document.getElementById("batchCriar")?.addEventListener("click", () => {
              ...
              obras.forEach((o) => (0, exports.obraStore)().adicionar(o));
              fecharModal();
      ...
      `);
          ...
          const aplicarTransformacoes = () => {
            ...
            let w = imgObj.width;
            let h2 = imgObj.height;
            if (angulo % 180 !== 0) {
              const novoW = h2 * cos + w * sin;
              const novoH = h2 * sin + w * cos;
              ...
              offCtx.drawImage(imgObj, -w / 2, -h2 / 2);
            } else {
              offscreen.width = w;
              offscreen.height = h2;
        ...
        abrirFichaTecnica(id) {
          const o = (0, exports.obraStore)().porId(id);
          if (!o)
            return;
    ...
    `);
        ...
        adicionarComparacao(id) {
          if (this.idsComparacao.includes(id)) {
            ...
            if (this.idsComparacao.length === 0)
              this.modoComparacao = false;
          } else {
        ...
        excluirObra(id) {
          ...
          if (!confirmado)
            return;
          (0, exports.obraStore)().remover(id);
      ...
      exports.CatalogoView = CatalogoView;
      var ClientesView = class extends BaseView {
        ...
        clientesFiltrados() {
          let clientes = (0, exports.clienteStore)().items;
          if (this.busca) {
            const termo = this.busca.toLowerCase();
            clientes = clientes.filter((c) => (c.nome || "").toLowerCase().includes(termo) || (c.email || "").toLowerCase().includes(termo) || (c.tags || []).some((t) => t.toLowerCase().includes(termo)));
          }
          return [...clientes].sort((a, b) => (a.nome || "").localeCompare(b.nome || ""));
        }
        comprasDoCliente(clienteId) {
          return (0, exports.vendaStore)().items.filter((v) => v.clienteId === clienteId).sort((a, b) => new Date(b.data) - new Date(a.data));
        }
        render() {
    ...
    `;
        ...
        bulkAcao(acao) {
          ...
          switch (acao) {
            case "exportar": {
              const clientes = ids.map((id) => (0, exports.clienteStore)().porId(id)).filter(Boolean);
              const csv = [
            ...
            case "excluir": {
              ids.forEach((id) => {
                const c = (0, exports.clienteStore)().porId(id);
                if (c && !(0, exports.vendaStore)().items.some((v) => v.clienteId === id)) {
                  (0, exports.clienteStore)().remover(id);
                }
              });
        ...
        abrirFormulario(id = null) {
          const existente = id ? (0, exports.clienteStore)().porId(id) : null;
          abrirModal(`
    ...
    `);
          ...
          document.getElementById("formCliente").addEventListener("submit", (e) => {
            ...
            if (existente) {
              (0, exports.clienteStore)().atualizar(existente.id, dados);
              mostrarToast("Cliente atualizado com sucesso!");
            } else {
              dados.aquisicoes = 0;
              (0, exports.clienteStore)().adicionar(dados);
        ...
        excluirCliente(id) {
          const cliente = (0, exports.clienteStore)().porId(id);
          if (!cliente)
            return;
          const temVendas = (0, exports.vendaStore)().items.some((v) => v.clienteId === id);
          if (temVendas) {
    ...
    `);
      ...
      var VendasView = class extends BaseView {
        ...
        vendasFiltradas() {
          const f = this.filtros;
          let vendas = (0, exports.vendaStore)().items;
          if (f.cliente)
            vendas = vendas.filter((v) => v.clienteId === f.cliente);
          if (f.status)
            vendas = vendas.filter((v) => classeStatusVenda(v.status) === classeStatusVenda(f.status));
          if (f.dataInicio)
            vendas = vendas.filter((v) => new Date(v.data) >= new Date(f.dataInicio));
          if (f.dataFim)
            vendas = vendas.filter((v) => new Date(v.data) <= new Date(f.dataFim));
    ...
    `;
        ...
        aposRenderizar() {
          ...
          if (btnNova)
            btnNova.addEventListener("click", () => this.abrirFormulario());
          ...
          const clickHandler = (e) => {
            ...
            if (alvoRecibo) {
              this.pdfGenerator.abrirModalAssinatura((0, exports.vendaStore)().porId(alvoRecibo.dataset.gerarRecibo), "recibo");
              return;
            }
            if (alvoProposta) {
              this.pdfGenerator.abrirModalAssinatura((0, exports.vendaStore)().porId(alvoProposta.dataset.gerarProposta), "proposta");
              return;
            }
            if (alvoCancelar) {
          ...
          const changeHandler = (e) => {
            ...
            if (selectStatus)
              this.atualizarStatus(selectStatus.dataset.statusVenda, e.target.value);
          };
          container.addEventListener("change", changeHandler);
          this._bindCache["delegVendasChange"] = { el: container, handler: changeHandler, type: "change" };
        }
        atualizarStatus(id, novoStatus) {
          (0, exports.vendaStore)().atualizar(id, { status: novoStatus });
        ...
        bulkAcao(acao) {
          ...
          switch (acao) {
            case "exportar": {
              const vendas = ids.map((id) => (0, exports.vendaStore)().porId(id)).filter(Boolean);
              const obras = (0, exports.obraStore)().items;
              const clientes = (0, exports.clienteStore)().items;
              const csv = [
        ...
        abrirFormulario() {
          const obrasDisponiveis = (0, exports.obraStore)().items.filter((o) => classeStatus(o.status) !== "vendida");
          const clientes = (0, exports.clienteStore)().items;
    ...
    `);
          ...
          document.getElementById("campoObraVenda").addEventListener("change", (e) => {
            ...
            if (opt && opt.dataset.preco)
              document.getElementById("campoPrecoVenda").value = opt.dataset.preco;
          });
          ...
          document.getElementById("formVenda").addEventListener("submit", (e) => {
            ...
            if (clienteId === "__novo__") {
              ...
              const novoCliente = (0, exports.clienteStore)().adicionar({
                nome: nomeNovo,
            ...
            (0, exports.vendaStore)().adicionar(dadosVenda);
            (0, exports.obraStore)().atualizar(obraId, { status: "vendida" });
            const cliente = (0, exports.clienteStore)().porId(clienteId);
            if (cliente)
              (0, exports.clienteStore)().atualizar(clienteId, { aquisicoes: (cliente.aquisicoes || 0) + 1 });
            fecharModal();
        ...
        cancelarVenda(id) {
          const venda = (0, exports.vendaStore)().porId(id);
          if (!venda)
            return;
          if (!confirm("Cancelar esta venda? A obra voltar\xE1 a ficar dispon\xEDvel no cat\xE1logo."))
            return;
          (0, exports.obraStore)().atualizar(venda.obraId, { status: "dispon\xEDvel" });
          const cliente = (0, exports.clienteStore)().porId(venda.clienteId);
          if (cliente)
            (0, exports.clienteStore)().atualizar(venda.clienteId, { aquisicoes: Math.max(0, (cliente.aquisicoes || 0) - 1) });
          (0, exports.vendaStore)().remover(id);
    ...
    `);
          ...
          document.querySelectorAll("[data-escolher-venda]").forEach((btn) => {
            btn.addEventListener("click", () => {
              const venda = (0, exports.vendaStore)().porId(btn.dataset.escolherVenda);
              fecharModal();
    ...
    `;
        ...
        excluirCertificado(id) {
          if (!confirm("Excluir este certificado do hist\xF3rico? O PDF j\xE1 baixado n\xE3o ser\xE1 afetado."))
            return;
        ...
        gerarNumeroSerie() {
          const ano = (/* @__PURE__ */ new Date()).getFullYear();
          const cfg = (0, exports.configStore)();
          if (!cfg.contadorCertificados)
            cfg.contadorCertificados = {};
        ...
        abrirFormulario() {
          const obras = (0, exports.obraStore)().items;
          const assinaturaSalva = (0, exports.configStore)().artista?.assinatura || "";
          abrirModal(`
    ...
    `);
          ...
          document.getElementById("formCertificado").addEventListener("submit", async (e) => {
            ...
            if (document.getElementById("campoSalvarAssinatura").checked) {
              (0, exports.configStore)().artista = (0, exports.configStore)().artista || {};
              (0, exports.configStore)().artista.assinatura = assinaturaDataUrl;
              (0, exports.configStore)().salvar();
            }
        ...
        async gerarPdfCertificado(cert, assinaturaDataUrl) {
          ...
          const artista = (0, exports.configStore)().artista || {};
          const nomeArtista = artista.nome || "Ateli\xEA do Artista";
          doc.setDrawColor(190);
          doc.setLineWidth(0.9);
          doc.rect(10, 10, w - 20, h2 - 20);
          doc.setLineWidth(0.25);
          doc.rect(14, 14, w - 28, h2 - 28);
          ...
          doc.setDrawColor(210);
          doc.line(25, h2 - 20, w - 25, h2 - 20);
          doc.setFontSize(8);
          doc.setTextColor(150);
          doc.text(`Emitido em ${(/* @__PURE__ */ new Date()).toLocaleDateString("pt-BR")} \xB7 Atelier CRM`, w / 2, h2 - 14, { align: "center" });
          doc.save(`certificado-${cert.numeroSerie.toLowerCase()}.pdf`);
          mostrarToast("Certificado gerado com sucesso!");
        }
      };
      exports.CertificadosView = CertificadosView;
      var ReferenciasView = class extends BaseView {
        ...
        referenciasFiltradas() {
          ...
          const f = this.filtros;
          if (f.tag)
            refs = refs.filter((r) => (r.tags || []).includes(f.tag));
          if (f.categoria)
            refs = refs.filter((r) => r.categoria === f.categoria);
          if (f.obra)
            refs = refs.filter((r) => r.obraVinculada === f.obra);
          return refs;
        }
        tagsDisponiveis() {
    ...
    `;
        ...
        aposRenderizar() {
          ...
          if (btnApresentar)
            btnApresentar.addEventListener("click", () => this.abrirApresentacao(0));
        ...
        ligarDragAndDrop() {
          ...
          cards.forEach((card) => {
            ...
            card.addEventListener("drop", (e) => {
              ...
              if (this.indiceArrastado === null || this.indiceArrastado === indiceDestino)
                return;
    ...
    `);
        ...
        excluirReferencia(id) {
          if (!confirm("Remover este item do board de refer\xEAncias?"))
            return;
        ...
        abrirApresentacao(indiceInicial) {
          ...
          this._teclaApresentacao = (e) => {
            if (e.key === "Escape")
              this.fecharApresentacao();
            if (e.key === "ArrowRight")
              this.navegarApresentacao(1);
            if (e.key === "ArrowLeft")
              this.navegarApresentacao(-1);
          };
        ...
        renderizarSlideApresentacao() {
          ...
          let midiaHtml = "";
          if (item.tipo === "imagem")
            midiaHtml = `<img class="midia-apresentacao" src="${item.imagem}" alt="${item.titulo || ""}">`;
          else if (item.tipo === "link")
            midiaHtml = `<img class="midia-apresentacao" src="${item.url}" alt="${item.titulo || ""}" onerror="this.outerHTML='<div class=\\'nota-apresentacao\\'>Link: ${item.url}</div>'">`;
          else
            midiaHtml = `<div class="nota-apresentacao">${item.nota || ""}</div>`;
          overlay.innerHTML = `
      ${midiaHtml}
    ...
    `;
      ...
      exports.ReferenciasView = ReferenciasView;
      var GaleriaVirtualView = class {
        ...
        carregarObras() {
          const todas = (0, exports.obraStore)().items;
          ...
          if (this.obrasVisiveis.length > 20)
            this.obrasVisiveis = this.obrasVisiveis.slice(0, 20);
        }
        render() {
          this.carregarObras();
      ...
      <div class="galeria-virtual" id="galeriaContainer">
        ...
        _initThree() {
          ...
          this.camera = new THREE.PerspectiveCamera(50, w / h2, 1, 2e3);
          this._updateCamera();
        ...
        _criarParedeEstrutural(id, mat, w, h2) {
          const mesh = new THREE.Mesh(new THREE.PlaneGeometry(w, h2), mat);
        ...
        _checkClick() {
          if (!this.raycaster || !this.camera || !this.renderer)
            return;
        ...
        _focarObraTour(idx) {
          if (idx < 0 || idx >= this.obraData.length)
            return;
          this.tourIndex = idx;
...
Aprecie a exposi\xE7\xE3o!`;
      ...
      <button class="btn-toast" id="btnAbrirLinkCompartilhado">Abrir</button>`;
          ...
          document.getElementById("btnAbrirLinkCompartilhado")?.addEventListener("click", () => {
            toast.remove();
            if (this.router)
              this.router.navegar("galeriaVirtual");
          });
          setTimeout(() => {
            if (toast.parentNode)
              toast.remove();
      ...
      exports.GaleriaVirtualView = GaleriaVirtualView;
      var PrecificadorView = class extends BaseView {
        ...
        get config() {
          return (0, exports.configStore)().precificador || {};
        }
        get cfgRoot() {
          return (0, exports.configStore)();
        }
        get moeda() {
        ...
        render() {
          ...
          const opcoesObra = obras.map((o) => `<option value="${o.id}">${o.titulo || "Sem t\xEDtulo"} \u2014 ${this.fmt(o.preco)}</option>`).join("");
          return `
        ...
        <div class="precificador-toolbar">
          <div class="moeda-selector">
            ...
            <select id="selMoedaPadrao">
              ${["BRL", "USD", "EUR", "GBP"].map((m) => `<option value="${m}" ${this.moeda === m ? "selected" : ""}>${m}</option>`).join("")}
            </select>
          ...
          <div class="calc-grid">
            ...
            <div class="campo-calc">
              ...
              <div class="estrelas-input" id="estrelasInput">
                ${[1, 2, 3, 4, 5].map((i) => `<span class="estrela ${i <= this.calc.complexidade ? "preenchida" : ""}" data-val="${i}">\u2605</span>`).join("")}
              </div>
            </div>
          </div>
    ...
    `;
        ...
        detalharCalculo(preco) {
          ...
          return `${this.fmt(m)} + (${h2}h \xD7 ${this.fmt(vh)}) \xD7 ${mult} \xD7 ${fator}${bonus !== 1 ? ` \xD7 ${bonus.toFixed(2)} (\xE1rea)` : ""} = ${this.fmt(preco)}`;
        }
        renderFaixaComparativa(obras) {
          const c = this.calc;
          const area = (Number(c.largura) || 0) * (Number(c.altura) || 0);
          if (!area || obras.length < 2)
            return "";
    ...
    `;
        ...
        renderProjecao(obras) {
          ...
          if (comHistorico.length === 0)
            return "";
          const selOpts = comHistorico.map((o) => `<option value="${o.id}">${o.titulo || "Sem t\xEDtulo"}</option>`).join("");
    ...
    `;
        ...
        projetarPreco(obra) {
          ...
          const pts = hist.map((h2) => ({ preco: Number(h2.preco), data: new Date(h2.data).getTime() }));
        ...
        renderProjecaoDetalhe(obra, proj) {
          if (!proj)
            return '<p style="color:var(--text-muted);">Dados insuficientes para proje\xE7\xE3o (m\xEDn. 2 pontos).</p>';
          return `
    ...
    `;
        ...
        renderHistoricoPrecos(obras) {
          ...
          const obra = comHistorico[0];
          const hist = obra.historicoPrecos;
          const precos = hist.map((h3) => Number(h3.preco)).concat([Number(obra.preco) || 0]).filter((p) => p > 0);
          if (precos.length < 2)
            return "";
          ...
          const cw = w - padX * 2, ch = h2 - padY * 2;
      ...
      <div class="card">
        ...
        <svg viewBox="0 0 ${w} ${h2}" class="svg-chart" style="height:${h2}px;">
    ...
    `;
        ...
        renderAnalise(obras, vendas) {
          ...
          const subprecificadas = obras.filter((o) => {
            if (!o.preco || !o.dimensoes || !o.dimensoes.largura || !o.dimensoes.altura)
              return false;
            const area = o.dimensoes.largura * o.dimensoes.altura;
            const similares = obras.filter((s) => {
              if (s.id === o.id || !s.preco)
                return false;
              const sd = s.dimensoes;
              if (!sd || !sd.largura || !sd.altura)
                return false;
    ...
    `;
        ...
        aposRenderizar() {
          ...
          ["calcMateriais", "calcHoras", "calcValorHora", "calcLargura", "calcAltura"].forEach((id) => {
            ...
            const handler = () => {
              ...
              if (id === "calcValorHora")
                this.salvarConfig({ valorHora: Number(el.value) || 60 });
          ...
          if (selObra) {
            const handler = () => {
              const obra = (0, exports.obraStore)().porId(selObra.value);
              if (obra) {
        ...
        atualizarResultado() {
          ...
          if (elValor)
            elValor.textContent = this.fmt(preco);
          if (elDetalhe)
            elDetalhe.textContent = this.detalharCalculo(preco);
          if (elConversoes) {
            const moedas = ["USD", "EUR", "GBP"];
            elConversoes.innerHTML = moedas.filter((m) => m !== this.moeda).map((m) => `<span class="conv-moeda">${m}: ${this.fmt(this.converter(preco, this.moeda, m), m)}</span>`).join("");
          }
          if (elFaixa) {
            const obras = (0, exports.obraStore)().items || [];
        ...
        salvarPrecoNaObra() {
          ...
          const obra = (0, exports.obraStore)().porId(obraId);
          if (!obra) {
          ...
          (0, exports.obraStore)().atualizar(obraId, {
            preco: precoSugerido,
        ...
        aplicarRegra(idx) {
          ...
          obras.forEach((o) => {
            ...
            if (!dim)
              return;
            if (regra.tecnica && o.tecnica !== regra.tecnica)
              return;
            if (dim.largura < regra.larguraMin || dim.largura > regra.larguraMax)
              return;
            if (dim.altura < regra.alturaMin || dim.altura > regra.alturaMax)
              return;
            ...
            if (preco > 0) {
              ...
              (0, exports.obraStore)().atualizar(o.id, { preco, historicoPrecos: hist });
              count++;
            }
          });
        ...
        aplicarRegrasEmTodas() {
          ...
          semPreco.forEach((o) => {
            ...
            const regraAplicada = regras.find((r) => {
              if (r.tecnica && o.tecnica !== r.tecnica)
                return false;
              if (dim.largura < r.larguraMin || dim.largura > r.larguraMax)
                return false;
              if (dim.altura < r.alturaMin || dim.altura > r.alturaMax)
                return false;
              return true;
            });
            if (!regraAplicada)
            ...
            if (preco > 0) {
              (0, exports.obraStore)().atualizar(o.id, { preco });
              count++;
            }
          });
        ...
        exportarRelatorioPDF() {
          ...
          const vendas = (0, exports.vendaStore)().items || [];
          const cfg = this.config;
          const artista = (0, exports.configStore)().artista?.nome || "Artista";
          let y = 20;
          const margem = 20;
          const larg = 170;
          doc.setFont("helvetica", "bold");
      ...
      exports.PrecificadorView = PrecificadorView;
      var AtelierView = class extends BaseView {
        ...
        get obras() {
          return (0, exports.obraStore)().items;
        }
        render() {
    ...
    `;
      ...
      <div class="forn-grid">
        ...
        ${fornecedores.map((f) => {
            ...
            const totalGasto = hist.reduce((s, h2) => s + Number(h2.valor || 0), 0);
            return `
            <div class="forn-card">
              ...
              ${hist.length > 0 ? `
                <div class="forn-hist">
                  ...
                  ${hist.map((h2) => `<div class="hist-item"><span>${h2.data || ""} \xE2\u20AC\u201D ${h2.itens || ""}</span><span>${formatarMoeda(Number(h2.valor) || 0)}</span></div>`).join("")}
                </div>
              ` : ""}
    ...
    `;
        ...
        renderCustoDetalhe(obraId) {
          const obra = (0, exports.obraStore)().items.find((o) => o.id === obraId);
          if (!obra)
            return '<p style="color:var(--text-muted);">Obra n\xC3\xA3o encontrada.</p>';
        ...
        aposRenderizar() {
          ...
          if (selCusto) {
            const handler = () => {
              ...
              if (detalhe)
                detalhe.innerHTML = selCusto.value ? this.renderCustoDetalhe(selCusto.value) : '<p style="color:var(--text-muted);font-size:0.85rem;">Selecione uma obra para ver o detalhamento de custos.</p>';
            };
          ...
          if (container) {
            const handler = (e) => {
              ...
              if (acao === "editarMaterial")
                this.abrirFormMaterial(false, id);
              else if (acao === "excluirMaterial")
                this.excluirMaterial(id);
              else if (acao === "consumirMaterial")
                this.consumirRapido(id);
              else if (acao === "excluirConsumo")
                this.excluirConsumo(id);
              else if (acao === "editarFornecedor")
                this.abrirFormFornecedor(id);
              else if (acao === "excluirFornecedor")
                this.excluirFornecedor(id);
              else if (acao === "marcarComprado")
                this.marcarComprado(id, true);
              else if (acao === "desmarcarComprado")
                this.marcarComprado(id, false);
    ...
    `);
        ...
        excluirConsumo(id) {
          if (!confirm("Excluir este registro de consumo?"))
            return;
...
`;
      ...
      exports.AtelierView = AtelierView;
      var RedeView = class extends BaseView {
        ...
        get clientes() {
          return (0, exports.clienteStore)().items;
        }
        render() {
        ...
        renderContatos() {
          ...
          if (this.filtroEstagio)
            filtrados = filtrados.filter((c) => c.estagio === this.filtroEstagio);
          const hoje = /* @__PURE__ */ new Date();
          return `
      ...
      ${selValue ? this.renderTimelineContato(selValue) : '<p style="color:var(--text-muted);font-size:0.85rem;">Selecione um contato para ver o historico de interacoes.</p>'}`;
        ...
        renderTimelineContato(contatoId) {
          ...
          if (!c)
            return '<p style="color:var(--text-muted);">Contato nao encontrado.</p>';
          return `
      ...
      <div class="evt-grid">${eventos.length === 0 ? '<p style="color:var(--text-muted);font-size:0.85rem;">Nenhum evento cadastrado.</p>' : ""}${eventos.map((e) => {
            const obras = (e.obrasEnviadas || []).map((oId) => {
              const o = (0, exports.obraStore)().items.find((o2) => o2.id === oId);
        ...
        renderMapa() {
          ...
          if (contatos.length === 0)
            return '<p style="color:var(--text-muted);font-size:0.85rem;">Adicione contatos para ver o mapa.</p>';
          return `
      <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:12px;">
      ...
      <div id="d3MapaHubs" style="margin-top:12px;font-size:0.85rem;color:var(--text-muted);">\u{1F4A1} Processando rede...</div>`;
        ...
        aposRenderizar() {
          ...
          document.querySelectorAll(".tab-btn[data-tab]").forEach((btn) => {
            ...
            this._bindCache["tab_" + btn.dataset.tab] = { el: btn, handler: h2, type: "click" };
          });
          ...
          if (filtroCat) {
            ...
            filtroCat.addEventListener("change", h2);
            this._bindCache["filtroCatRede"] = { el: filtroCat, handler: h2, type: "change" };
          }
          ...
          if (filtroEst) {
            ...
            filtroEst.addEventListener("change", h2);
            this._bindCache["filtroEstagioRede"] = { el: filtroEst, handler: h2, type: "change" };
          }
          ...
          if (selInt) {
            ...
            selInt.addEventListener("change", h2);
            this._bindCache["selInteracaoContato"] = { el: selInt, handler: h2, type: "change" };
          }
          ...
          if (container) {
            const h2 = (e) => {
              ...
              } else if (acao === "pipeMovEsq")
                this.moverPipeline(id, -1);
              else if (acao === "pipeMovDir")
                this.moverPipeline(id, 1);
              else if (acao === "editarEvento")
                this.abrirFormEvento(id);
              else if (acao === "excluirEvento")
                this.excluirEvento(id);
            };
            container.addEventListener("click", h2);
            this._bindCache["delegatedRede"] = { el: container, handler: h2, type: "click" };
          }
        ...
        iniciarMapaD3() {
          ...
          const node = g.append("g").selectAll("g").data(nodes).join("g").call(d3.drag().on("start", (event, d) => {
            if (!event.active)
...
${this.catLabels[d.categoria] || d.categoria || ""}${d.instituicao ? "\n" + d.instituicao : ""}${d.nivelRelacionamento ? "\nRelacionamento: " + "\u2605".repeat(d.nivelRelacionamento) : ""}`);
          ...
          setTimeout(() => {
            ...
            links.forEach((l) => {
              ...
              if (srcId)
                hubCounts[srcId] = (hubCounts[srcId] || 0) + 1;
              if (tgtId)
                hubCounts[tgtId] = (hubCounts[tgtId] || 0) + 1;
            });
            ...
            if (hubsDiv)
              hubsDiv.innerHTML = hubs ? `\u{1F4A1} Contatos que mais conectam (hubs): ${hubs}` : "\u{1F4A1} Nenhum hub identificado.";
          }, 2e3);
        }
      ...
      <div class="modal-acoes"><button type="button" class="btn-secundario" id="btnCancelarModal">Cancelar</button><button type="submit" class="btn-primario">Salvar</button></div></form>`);
        ...
        abrirFormEvento(id = null) {
          ...
          const obras = this.obras || (0, exports.obraStore)().items;
      ...
      <form id="formModal"><div class="modal-form-grid">
        ...
        verificarLembretes() {
          ...
          contatos.forEach((c) => {
            ...
            if (dias > 60)
              pendentes.push({ nome: c.nome, dias, passo: c.proximoPasso || "revisar relacionamento" });
          });
    ...
    `;
        ...
        renderCardEntrada(e) {
          ...
          const obrasNomes = (e.obrasTrabalhadas || []).map((id) => {
            const o = (0, exports.obraStore)().items.find((o2) => o2.id === id);
            return o ? o.titulo : null;
          }).filter(Boolean);
          const fotos = e.fotos || [];
          return `
    ...
    `;
        ...
        renderCronograma() {
          ...
          for (let i = 1; i <= diasNoMes; i++) {
            ...
            atividades.forEach((a) => {
              ...
              if (texto.includes("escultura") || texto.includes("argila") || texto.includes("bronze"))
                cores.push("escultura");
              else if (texto.includes("admin") || texto.includes("organiz") || texto.includes("email") || texto.includes("papel") || texto.includes("nota"))
                cores.push("admin");
              else if (a.horasTrabalhadas === 0 || a.bloqueios && a.bloqueios.includes("descanso"))
                cores.push("descanso");
              else
                cores.push("pintura");
            });
      ...
      <div class="cal-grid">
        ...
        ${[...diasMesAnterior, ...diasMes, ...diasProxMes].map((cel) => {
            ...
            if (cel.ehHoje)
              classes.push("hoje");
            if (cel.atividades && cel.atividades.length > 0)
              classes.push("tem-atividade");
            if (cel.prazos && cel.prazos.length > 0)
              classes.push("tem-prazo");
            return `
    ...
    `;
        ...
        renderEstatisticas() {
          ...
          let totalHoras = 0;
          entradas.forEach((e) => {
            if (!e.data || !e.horasTrabalhadas)
              return;
            const d = new Date(e.data);
            const semana = `${d.getFullYear()}-S${Math.ceil((d.getDate() - d.getDay() + 1) / 7)}`;
            const mes = `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, "0")}`;
            const ano = d.getFullYear();
            const h2 = e.horasTrabalhadas || 0;
            horasSemana[semana] = (horasSemana[semana] || 0) + h2;
            horasMes[mes] = (horasMes[mes] || 0) + h2;
            horasAno[ano] = (horasAno[ano] || 0) + h2;
            totalHoras += h2;
          });
          const tecnicas = {};
          entradas.forEach((e) => {
          ...
          obras.forEach((o) => {
            ...
            if (dias > 0 && o.tecnica) {
              if (!mediasObra[o.tecnica])
                mediasObra[o.tecnica] = { total: 0, count: 0 };
          ...
          const barras = meses.map((m, i) => {
            ...
            const h2 = m.horas / maxHoras * (altUtil - 10);
            const y = svgH - 10 - h2;
            return `<rect class="stats-bar" x="${x}" y="${y}" width="${Math.max(largBarra, 6)}" height="${Math.max(h2, 2)}" rx="3"></rect>
    ...
    `;
        ...
        aposRenderizar() {
          ...
          document.querySelectorAll(".cal-cell[data-data]").forEach((cel) => {
            ...
            cel.addEventListener("click", h2);
            this._bindCache["cal_" + cel.dataset.data] = { el: cel, handler: h2, type: "click" };
          });
          ...
          if (selObra) {
            ...
            selObra.addEventListener("change", h2);
            this._bindCache["selObraProcesso"] = { el: selObra, handler: h2, type: "change" };
          }
          ...
          if (container) {
            const h2 = (e) => {
              ...
              if (!btn)
                return;
              const acao = btn.dataset.acao, id = btn.dataset.id;
              if (acao === "editarEntrada")
                this.abrirFormEntrada(id);
              else if (acao === "excluirEntrada")
                this.excluirEntrada(id);
              else if (acao === "editarEtapa")
                this.abrirFormEtapa(id);
              else if (acao === "excluirEtapa")
                this.excluirEtapa(id);
            };
            container.addEventListener("click", h2);
            this._bindCache["delegatedDiario"] = { el: container, handler: h2, type: "click" };
          }
        }
        abrirFormEntrada(id = null, dataPrefill = null) {
          ...
          const humorBtns = [1, 2, 3, 4, 5].map((n) => `<button type="button" class="humor-btn ${n === this._selHumor ? "selecionado" : ""}" data-humor="${n}">${this.humorEmojis[n]}</button>`).join("");
          abrirModal(`
    ...
    `);
        ...
        atualizarPhotoStrip() {
          ...
          if (!strip)
            return;
          strip.innerHTML = this._fotosTemporarias.map((f) => `<div class="ps-item"><img src="${f}"><button type="button" class="ps-remove" data-foto="${f}">\u{1F4F7}</button></div>`).join("");
        ...
        excluirEntrada(id) {
          if (!confirm("Excluir esta entrada do di\xE1rio?"))
            return;
        ...
        abrirFormEtapa(id = null) {
          ...
          let etapa = null;
          if (id && proc)
            etapa = (proc.etapas || []).find((e) => e.id === id);
          const etapaOpts = this.etapasPadrao.map((e) => `<option value="${e}" ${etapa && etapa.titulo === e ? "selected" : ""}>${e}</option>`).join("");
          abrirModal(`
    ...
    `);
        ...
        excluirEtapa(id) {
          if (!confirm("Excluir esta etapa do processo?"))
            return;
          const obraId = this._filtroObraProc;
      ...
      `;
          ...
          this.encomendas = this.dataStore.listar("encomendas").filter((e) => e.clienteNome === portal.clienteNome || e.clienteEmail === portal.clienteId);
    ...
    `;
      ...
      var EncomendasView = class extends BaseView {
        ...
        render() {
          ...
          const statusOpts = ["", "criado", "em_andamento", "aprovacao", "finalizado", "entregue", "cancelado"].map((s) => `<option value="${s}" ${this.filtroStatus === s ? "selected" : ""}>${s ? this.rotuloStatus(s) : "Todos"}</option>`).join("");
      ...
      <form id="formEncomenda">
        ...
        <div class="campo-form"><label>Status</label>
          <select id="encStatus" style="padding:8px;border:1px solid var(--border);border-radius:6px;font-size:0.85rem;width:100%;background:var(--bg);color:var(--text);">
            ${["criado", "em_andamento", "aprovacao", "finalizado", "entregue", "cancelado"].map((s) => `<option value="${s}" ${e.status === s ? "selected" : ""}>${this.rotuloStatus(s)}</option>`).join("")}
          </select>
        </div>
        <div class="modal-acoes">
    ...
    `);
        ...
        abrirModalAtualizacao(encId) {
          ...
          const statusOpts = ["criado", "em_andamento", "aprovacao", "finalizado", "entregue", "cancelado"].map((s) => `<option value="${s}" ${enc.status === s ? "selected" : ""}>${this.rotuloStatus(s)}</option>`).join("");
          abrirModal(`
    ...
    `);
        ...
        gerarLinkPortal() {
          ...
          const cliente = (0, exports.clienteStore)().items.find((c) => c.id === sel.value);
          if (!cliente) {
        ...
        removerPortal(portalId) {
          if (!confirm("Remover este link de acesso?"))
            return;
        ...
        excluirEncomenda(id) {
          if (!confirm("Excluir esta encomenda permanentemente?"))
            return;
      ...
      exports.EncomendasView = EncomendasView;
      var ImageLightbox = class {
        ...
        startAutoPlay() {
          if (this.autoPlayTimer || this.images.length <= 1)
            return;
    ...
    `).join("");
        ...
        _showImage() {
          ...
          const parts = [];
          if (img.title)
            parts.push(img.title);
          if (img.subtitle)
            parts.push(img.subtitle);
          captionTitle.textContent = parts.join(" \xB7 ") || "";
          if (img.price)
            captionSub.textContent = img.price;
          else
            captionSub.textContent = img.caption || "";
        }
        _applyTransform() {
          const imgEl = this.overlay?.querySelector(".lb-img");
          if (!imgEl)
          ...
          if (ind)
            ind.textContent = `${Math.round(this.scale * 100)}%`;
        }
        _setScale(s) {
        ...
        _bindEvents() {
          ...
          this.overlay?.querySelector(".lb-main")?.addEventListener("mousedown", (e) => {
            if (e.target.closest(".lb-caption") || e.target.closest(".lb-thumbstrip"))
              return;
    ...
    `;
        ...
        renderPainel() {
          if (this.abaAtiva === "exportar")
            return this.renderExportar();
          if (this.abaAtiva === "importar")
            return this.renderImportar();
    ...
    `;
        ...
        renderPreview() {
          ...
          const linhas = this.previewData.colecoes.map((c) => `<tr><td>${c.nome}</td><td>${c.quantidade}</td><td>${c.quantidade > 0 ? "\u{1F195} Novos dados" : "\u2014"}</td></tr>`).join("");
    ...
    `;
        ...
        renderHistorico() {
          ...
          const linhas = historico.map((h2, i) => {
            const tamanho = h2.tamanho > 1024 ? `${(h2.tamanho / 1024).toFixed(1)} KB` : `${h2.tamanho} B`;
            const data = formatarData(h2.data);
            const tipo = typeof h2.tipo === "string" ? h2.tipo : "completo";
            return `
        <tr>
          <td>${data}</td>
    ...
    `;
        ...
        configurarImportar() {
          ...
          fileInput2.addEventListener("change", () => {
            if (fileInput2.files[0])
              this.processarArquivo(fileInput2.files[0]);
          });
        }
          ...
          document.getElementById("eiConfirmarImport")?.addEventListener("click", () => {
            ...
            if (resultado.sucesso) {
              ...
              if (container)
                container.innerHTML = "";
              if (this.router)
                this.router.navegar(this.router.viewAtual);
            } else {
      ...
      exports.ExportImportView = ExportImportView;
    ...
    `);
        ...
        excluirExposicao(id) {
          if (!confirm("Excluir esta exposicao permanentemente?"))
            return;
      ...
      exports.ExposicoesView = ExposicoesView;
    ...
    `;
        ...
        filtrarTransacoes() {
          ...
          if (this.filtroTipo)
            lista = lista.filter((t) => t.tipo === this.filtroTipo);
          if (this.busca) {
            const q = this.busca.toLowerCase();
        ...
        <div class="campo-form" style="display:grid;grid-template-columns:1fr 1fr;gap:8px;">
          ...
          <div><label>Categoria</label>
            <select id="transCategoria" style="padding:8px;border:1px solid var(--border);border-radius:6px;font-size:0.85rem;width:100%;background:var(--bg);color:var(--text);">
              <option value="">\u2014 Selecione \u2014</option>
              ${["Venda", "Comissao", "Material", "Inscricao", "Frete", "Embalagem", "Ferramenta", "Assinatura", "Outro"].map((cat) => `<option value="${cat}" ${e.categoria === cat ? "selected" : ""}>${cat}</option>`).join("")}
            </select>
          </div>
        </div>
    ...
    `);
      ...
      exports.FinanceiroView = FinanceiroView;
      var ConfiguracoesView = class extends BaseView {
        ...
        _salvar() {
          ...
          (0, exports.configStore)().artista = { nome, email, telefone };
          (0, exports.configStore)().textoGarantia = document.getElementById("cfgTextoGarantia").value.trim();
          const langSel = document.getElementById("cfgIdioma");
          if (langSel) {
            (0, exports.configStore)().idioma = langSel.value;
            if (window.AtelierCRMTranslations) {
        ...
        _salvarPin() {
          ...
          if (pinVal && pinVal.length === 4 && /^\d{4}$/.test(pinVal)) {
            (0, exports.configStore)().pin = pinVal;
            (0, exports.configStore)().salvar();
        ...
        _removerPin() {
          if (confirm("Remover o PIN de acesso?")) {
            (0, exports.configStore)().pin = "";
            (0, exports.configStore)().autoLock = false;
            (0, exports.configStore)().salvar();
            mostrarToast("PIN removido.");
            if (this.router.viewAtual === "configuracoes")
              this.router.navegar("configuracoes");
          }
        }
        render() {
          const cfg = (0, exports.configStore)().artista || {};
          const textoGarantia = (0, exports.configStore)().textoGarantia || "";
          const idiomaAtual = (0, exports.configStore)().idioma || "pt-BR";
          const altoContraste = (0, exports.configStore)().altoContraste || false;
          const tamanhoFonte = (0, exports.configStore)().tamanhoFonte || "medio";
          const pinAtivo = (0, exports.configStore)().pin || "";
          const s = (0, exports.configStore)();
      ...
      <div class="painel" style="max-width:560px;margin-top:16px;">
        ...
        <div class="campo-form">
          <label><input type="checkbox" id="cfgAutoLock" ${(0, exports.configStore)().autoLock ? "checked" : ""}> \u{1F510} Bloquear automaticamente ap\xF3s inatividade</label>
        </div>
      </div>
    ...
    `;
        ...
        aposRenderizar() {
          ...
          if (btnSalvar) {
            const h2 = () => this._salvar();
            btnSalvar.addEventListener("click", h2);
            this._bindCache["btnSalvarConfig"] = { el: btnSalvar, handler: h2, type: "click" };
          }
          const btnPin = document.getElementById("btnSalvarPin");
          if (btnPin) {
            const h2 = () => this._salvarPin();
            btnPin.addEventListener("click", h2);
            this._bindCache["btnSalvarPin"] = { el: btnPin, handler: h2, type: "click" };
          }
          const btnRem = document.getElementById("btnRemoverPin");
          if (btnRem) {
            const h2 = () => this._removerPin();
            btnRem.addEventListener("click", h2);
            this._bindCache["btnRemoverPin"] = { el: btnRem, handler: h2, type: "click" };
          }
    ...
    `;
      ...
      exports.ConfiguracoesView = ConfiguracoesView;
      var CloudSync = class {
        constructor(dataStore2) {
        ...
        async _reqGoogle(path, method, body) {
          ...
          if (!token)
            throw new Error("Google Drive n\xE3o autenticado");
          const opts = {
            method: method || "GET",
        ...
        async _reqWebDAV(path, method, body) {
          ...
          if (!cfg.url)
            throw new Error("WebDAV n\xE3o configurado");
          ...
          if (!res.ok)
            throw new Error("WebDAV HTTP " + res.status);
          return res;
        }
        async testarWebDAV() {
          try {
      ...
      exports.pinia = (0, pinia_1.createPinia)();
      exports.useObraStore = (0, pinia_1.defineStore)("obras", {
        state: () => ({
          items: [],
          _loaded: false
        }),
      ...
      var obraStore = () => (0, exports.useObraStore)(exports.pinia);
      exports.obraStore = obraStore;
      exports.useClienteStore = (0, pinia_1.defineStore)("clientes", {
        state: () => ({
          items: [],
          _loaded: false
        }),
      ...
      var clienteStore = () => (0, exports.useClienteStore)(exports.pinia);
      exports.clienteStore = clienteStore;
      exports.useVendaStore = (0, pinia_1.defineStore)("vendas", {
        state: () => ({
          items: [],
          _loaded: false
        }),
      ...
      var vendaStore = () => (0, exports.useVendaStore)(exports.pinia);
      exports.vendaStore = vendaStore;
      ...
      exports.useConfigStore = (0, pinia_1.defineStore)("config", {
        state: () => ({
          artista: { nome: "Meu Ateli\xEA", email: "", telefone: "", assinatura: "" },
          tema: "classico",
          idioma: "pt-BR",
        ...
        actions: {
          ...
          salvar() {
            try {
              ...
              _CAMPOS_SENSIVEIS.forEach((c) => {
                if (paraSalvar[c])
                  paraSalvar[c] = _codificar(paraSalvar[c]);
              });
      ...
      var configStore = () => (0, exports.useConfigStore)(exports.pinia);
      exports.configStore = configStore;
      var COLLECTION_STORE_MAP = {
        obras: { get: exports.useObraStore, single: exports.obraStore },
        clientes: { get: exports.useClienteStore, single: exports.clienteStore },
        vendas: { get: exports.useVendaStore, single: exports.vendaStore }
      };
      var StoreBridge = class {
        ...
        _initStores() {
          (0, exports.obraStore)().carregar(this.dataStore.listar("obras"));
          (0, exports.clienteStore)().carregar(this.dataStore.listar("clientes"));
          (0, exports.vendaStore)().carregar(this.dataStore.listar("vendas"));
          (0, exports.configStore)().carregar();
        }
        _piniaStore(colecao) {
          const entry = COLLECTION_STORE_MAP[colecao];
          return entry ? entry.get(exports.pinia) : null;
        }
        listar(colecao) {
  ...
  `;
      ...
      function sanitizarRich(str) {
        ...
        for (let match; (match = allowedTag.exec(str)) !== null; ) {
          ...
          if (texto)
            partes.push(texto.replace(/[&<>"']/g, (m) => escMap[m]));
          ...
          if (tag[1] === "/" || !attrs || !attrs.trim()) {
            ...
            for (let a; (a = safeAttr.exec(attrs)) !== null; )
              safe.push(a[0]);
        ...
        if (resto)
          partes.push(resto.replace(/[&<>"']/g, (m) => escMap[m]));
        return partes.join("");
      }
      ...
      function aplicarTransicaoView(container, chave) {
        ...
        if (!transicaoHistorico.includes(chave))
        ...
        if (transicaoHistorico.length > 20)
          transicaoHistorico.shift();
      ...
      function abrirSpotlight() {
        ...
        function salvarHistorico(termo) {
          ...
          try {
            ...
            hist = [termo, ...hist.filter((h2) => h2 !== termo)].slice(0, 5);
        ...
        const buscar = debounce2((termo) => {
          ...
          if (!termo) {
            try {
              ...
              if (hist.length > 0) {
                results.innerHTML = secao("Recentes", "\u{1F550}") + hist.map((h2) => `<div class="spotlight-item sp-historico" data-termo="${h2}"><span class="si-icone">\u{1F550}</span><span>${h2}</span><span class="si-info">busca recente</span></div>`).join("");
      ...
      function iniciarFab() {
        ...
        document.addEventListener("keydown", (e) => {
          if (e.key === "Escape" && fabSpeedial?.classList.contains("visivel"))
            fecharFab();
        });
      }
      ...
      function iniciarMonitorInatividade() {
        if (!dataStore?.dados?.config?.autoLock || !dataStore?.dados?.config?.pin)
          return;
        const resetTimer = () => {
          if (_telaBloqueada)
            return;
      ...
      function iniciarTour() {
        if (dataStore?.dados?.config?.tourCompleted)
          return;
        let passoAtual = 0;
        function mostrarPasso() {
          ...
          if (!alvo) {
            passoAtual++;
            if (passoAtual < tourPassos.length)
              mostrarPasso();
            else
              finalizarTour();
            return;
      ...
      window.mostrarToast = function(mensagem, tipo = "info") {
        const toast = document.getElementById("toast");
        if (!toast)
          return _mostrarToastOriginal?.(mensagem);
        toast.textContent = mensagem;
    ...
    `).join("");
      ...
      if (typeof module !== "undefined" && module.exports) {
        module.exports = {
          ...
          StoreBridge,
          pinia: exports.pinia,
          obraStore: exports.obraStore,
          useObraStore: exports.useObraStore,
          clienteStore: exports.clienteStore,
          useClienteStore: exports.useClienteStore,
          vendaStore: exports.vendaStore,
          useVendaStore: exports.useVendaStore,
          configStore: exports.configStore,
          useConfigStore: exports.useConfigStore,
          EventBus,
          ThemeEngine,
          Router,
          DashboardView,
